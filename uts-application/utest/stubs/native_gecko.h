...
// with the static inline functions converted to function prototypes. Function
...
struct gecko_msg_le_gap_set_phy_rsp_t* gecko_cmd_le_gap_set_phy(uint8 phy);
/**
*
...
struct gecko_msg_gatt_server_find_primary_service_rsp_t* gecko_cmd_gatt_server_find_primary_service(uint16 start,uint8 uuid_len, const uint8* uuid_data);
/**
*
...
struct gecko_msg_test_debug_command_rsp_t* gecko_cmd_test_debug_command(uint8 id,uint8 debugdata_len, const uint8* debugdata_data);
/**
*
...
struct gecko_msg_test_debug_counter_rsp_t* gecko_cmd_test_debug_counter(uint32 id);
/**
*
